...
NOTEBOOKS_REMOVE_RECURSIVE = [
    "./howtofit/chapter_phase_api/src/dataset",
    "./howtofit/chapter_phase_api/src/fit",
    "./howtofit/chapter_phase_api/src/model",
...
def main():
    ...
    for x in NOTEBOOKS_REMOVE_RECURSIVE:
