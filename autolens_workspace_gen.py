...
COPY_VERBATIM_FOLDERS = [
    "./imaging/advanced/pipelines/hyper/pipelines",
    "./imaging/advanced/pipelines/no_lens_light/pipelines",
    "./imaging/advanced/pipelines/with_lens_light/pipelines",
    "./imaging/advanced/slam/no_lens_light/pipelines",
    "./imaging/advanced/slam/with_lens_light/pipelines",
    "./interferometer/advanced/slam/pipelines",
